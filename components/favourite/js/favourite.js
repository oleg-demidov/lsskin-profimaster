    ...
    $.widget( "livestreet.lsFavourite", $.livestreet.lsComponent, {
        ...
        onToggleSuccess: function( response ) {
            ...
            if ( response.bState ) {
                ...
                this.elements.toggle.addClass( this.option('classes.added_icon') );
                this.elements.toggle.removeClass( this.option('classes.remove_icon') );
                this.element.attr( 'title', this._i18n( 'remove' ) );
            } else {
                this.elements.toggle.addClass( this.option('classes.remove_icon') );
                this.elements.toggle.removeClass( this.option('classes.added_icon') );
